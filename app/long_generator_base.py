...
La narracion debe ser en castellano natural, clara, serena e interesante, con ritmo de creador/documental moderno: voz continua, frases conectadas y casi sin silencios largos.
Cada capitulo debe tener aproximadamente 65 a 78 palabras para ocupar casi los 30 segundos a ritmo conversacional fluido. No empieces cada capitulo como si fuera un video nuevo; conecta la ultima idea del capitulo anterior con la primera del siguiente.
...
Debe sentirse como un influencer digital/streamer experto con excelente parla: seguro, agil, cercano, expresivo y natural. La voz debe ser CONTINUA durante casi todo el video, sin pausas largas ni reinicios de tono entre capitulos. No copies voz, frases, titulos ni estructura exacta de ningun creador real.
...
Cada capitulo debe tener aproximadamente 65 a 78 palabras y enlazarse con el siguiente como un solo discurso. Usa ejemplos con numeros redondos si ayudan, sin inventar tasas o datos actuales. No prometas dinero facil ni resultados garantizados.
...
Usa Analytics para elegir un enfoque que tenga sentido para esta audiencia: toma en cuenta videos con mejor tiempo de visualizacion, porcentaje visto, compartidos, likes y suscriptores ganados. Adapta ejemplos o vocabulario a paises/edades solo si esos datos aparecen. No copies un video anterior ni inventes datos faltantes.

Genera exactamente {CHAPTERS} capitulos consecutivos de {CHAPTER_SECONDS} segundos, total aproximado 5 minutos.
Debe existir continuidad narrativa: introduccion fuerte, desarrollo ordenado y cierre claro. La narracion debe sentirse como UN SOLO VIDEO y no como diez clips pegados.
...
{{
  ...
  "chapters": [
    {{
      ...
      "narration": "65 a 78 palabras, fluidas y conectadas con capitulos vecinos"
    }}
  ]
}}
...
- Cada narration debe conectarse con la siguiente y evitar introducciones repetidas.
...
def generate_long_metadata(channel: dict) -> dict[str, Any]:
    ...
    for index, chapter in enumerate(chapters, start=1):
        ...
        chapter["narration"] = " ".join(str(chapter["narration"]).split())
